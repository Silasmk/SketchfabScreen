...
var AppView = Backbone.View.extend( {
    ...
    onLoadSceneClick: function ( e ) {
        const load_scene_link_input = document.getElementById("load-scene-uid");
        const segments_link = load_scene_link_input.value.split('-');
        const load_scene_uid = segments_link[segments_link.length - 1];
        this.initViewer(load_scene_uid);       
    },
